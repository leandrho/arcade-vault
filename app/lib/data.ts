...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    long: "Salta entre carriles de coches a toda velocidad y troncos a la deriva en el río. Llega a los nenúfares antes de que se acabó el tiempo.",
    cat: "ARCADE",
    cover: "cover-rana",
    color: "green",
    best: 18900,
...
export function seededScores(seed: number, count: number = 12): Score[] {
  let s = seed;
  const rand = () => {
